...
<body class="body-form">
    ...
    <div>
        <h1 class="h1-titulo">Confirmar entrega</h1>
    </div>
    <form class="needs-validation" autocomplete="off" novalidate="">
        <div class="col-6 centrado">
            <div class="div-datos">
                <label class="form-label">Folio</label>
                <input class="form-control" type="text" id="txtFolio" name="txtFolio" pattern="[0-9]{5,30}" required="" maxlength="30" minlength="5">
